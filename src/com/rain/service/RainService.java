...
public interface RainService {
	 ...
	 * 会议信息
	 */
	List<Meetting> findAllMeet(String content);
	void addMeet(Meetting meetting);
	Meetting get_meet_info(Integer id);
	void update_meet_info(Meetting meetting);
	void delete_meet_info(Integer id);
	List<Meetting> findAllMeet();
	/**
	 * 部门信息的service
	 * @param content
	 * @return
